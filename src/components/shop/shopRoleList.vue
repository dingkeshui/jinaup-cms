<template>
	<div id="userList">
		<div v-if="showBox1" class="box">
            ...
            <el-button v-if="itemdata" size="small" @click="closethispage" type="primary">取消</el-button>
			    	<el-button v-else size="small" @click="addbut" type="primary">添加角色</el-button>
			    </div>
			</div>
        ...
        <div class="tablebox">
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <el-button type="warning" @click="choose(scope.row)" size="small">选择</el-button>
                </template>
              </el-table-column>
    				  <el-table-column
                v-else
